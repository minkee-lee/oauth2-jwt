...
/**
 * from OAuth2TokenEndpointFilter
 * - enable cors (add "access-control-allow-origin")
 */
public class DevOAuth2TokenSuccessHandler implements AuthenticationSuccessHandler {
